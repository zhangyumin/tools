...
jq '(.tracks) |= . + [{"storeClass" : "JBrowse/Store/SeqFeature/BigWig","urlTemplate" : "./'$name'.PosPA.bw","type" : "JBrowse/View/Track/Wiggle/XYPlot","label" : "'$name' positive tagNum","key" : "'$name' positive tagNum","autoscale" : "local","style" : {"neg_color" : "red","pos_color" : "blue"},"variance_ban" : false}]' /var/www/jbrowse/data/$des/trackList.json > /var/www/jbrowse/data/$des/trackList1.json
jq '(.tracks) |= . + [{"storeClass" : "JBrowse/Store/SeqFeature/BigWig","urlTemplate" : "./'$name'.NegPA.bw","type" : "JBrowse/View/Track/Wiggle/XYPlot","label" : "'$name' negetive tagNum","key" : "'$name' negetive tagNum","autoscale" : "local","style" : {"neg_color" : "red","pos_color" : "blue"},"variance_ban" : false}]' /var/www/jbrowse/data/$des/trackList1.json > /var/www/jbrowse/data/$des/trackList2.json
